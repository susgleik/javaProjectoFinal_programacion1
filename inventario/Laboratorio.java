...
public class Laboratorio {
	...
	private ArrayList<Medicamento>analquel_1 = new ArrayList<Medicamento>();
	private ArrayList<Medicamento>analquel_2 = new ArrayList<Medicamento>();
	private ArrayList<Medicamento>analquel_3 = new ArrayList<Medicamento>();
	...
	public void agregarMedicamento(Medicamento medicamento1,String nomString) {
	...
	public void mod_medicamento(int anaquel,int medicamento) {
		...
		try {
			switch (anaquel) {
			case 1:
				nombre=analquel_1.get(medicamento).getNombre_Comercial();
			...
			case 2:
				...
				nombre=analquel_2.get(medicamento).getNombre_Comercial();
				...
				break;
			case 3:
				nombre=analquel_3.get(medicamento).getNombre_Comercial();
	...
	public void mostrarMedicamentos() {
		...
		for (int i = 0; i <analquel_1.size() ; i++) {
			System.out.println(i+"-->"+analquel_1.get(i).getNombre_Comercial());
		}
		}
		...
		if(!analquel_2.isEmpty()) {
			...
			for (int i = 0; i <analquel_2.size() ; i++) {
				System.out.println(i+"-->"+analquel_2.get(i).getNombre_Comercial());
			}
			}
		if(!analquel_3.isEmpty()) {
			...
			for (int i = 0; i <analquel_3.size() ; i++) {
				System.out.println(i+"-->"+analquel_3.get(i).getNombre_Comercial());
			}
			}
		System.out.println("");
	}
			...
			for (int i = 0; i <analquel_1.size() ; i++) {
				...
				if (año ==año_us) {
					...
					if (mes ==mes_us) {
						...
						System.out.println("Nombre Comercial: "+analquel_1.get(i).getNombre_Comercial());
						System.out.println("Nombre Generico: "+analquel_1.get(i).getNombre_Generico());
				...
				for (int i = 0; i <analquel_2.size() ; i++) {
					...
					if (año ==año_us) {
						...
						if (mes ==mes_us) {
							System.out.println("");
							System.out.println("Medicamento: ");
							System.out.println("Nombre Comercial: "+analquel_2.get(i).getNombre_Comercial());
							System.out.println("Nombre Generico: "+analquel_2.get(i).getNombre_Generico());
							System.out.println("Laboratorio: "+this.nombre);
				...
				for (int i = 0; i <analquel_3.size() ; i++) {
					...
					if (año ==año_us) {
						...
						if (mes ==mes_us) {
							System.out.println("");
							System.out.println("Medicamento: ");
							System.out.println("Nombre Comercial: "+analquel_3.get(i).getNombre_Comercial());
							System.out.println("Nombre Generico: "+analquel_3.get(i).getNombre_Generico());
							System.out.println("Laboratorio: "+this.nombre);
	...
	public boolean buscar_medicamento_nom_gen(String nombreString) {
		...
		if(si_1) {
			...
			for (int i = 0; i <analquel_1.size() ; i++) {
				...
				nombre_usString = analquel_1.get(i).getNombre_Comercial();
			...
			for (int i = 0; i <analquel_2.size() ; i++) {
				nombre_usString = analquel_2.get(i).getNombre_Comercial();
				if (nombreString.equalsIgnoreCase(nombre_usString)) {
					existe=true;
			...
			for (int i = 0; i <analquel_3.size() ; i++) {
				nombre_usString = analquel_3.get(i).getNombre_Comercial();
				if (nombreString.equalsIgnoreCase(nombre_usString)) {
					existe=true;
